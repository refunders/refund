...
#' 
#' Defines a term \eqn{\int^{s_{hi, i}}_{s_{lo, i}} f(X_i(s), s, t) ds} 
...
#'      or \code{"t2"} for an alternative parameterization of tensor product splines (see \code{\link[mgcv]{t2}}).
...
#'   and weight matrices (see \code{\link[mgcv]{linear.functional.terms}}) 
