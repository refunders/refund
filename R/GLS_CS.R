...
#'   functions (\code{beta.hat}), confidence bounds (\code{beta.UB},
#'   \code{beta.LB}), fitted values (\code{Yhat}), the fitted \code{lm}
#'   object (\code{model.gls}), and estimated residual covariance
#'   (\code{sigma}).
