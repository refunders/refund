...
#' Series C}, 65 215-236.
#'
#' @return A list of class \code{"fosr"} returned by the selected fitting
#'   function. See the individual fitting functions for details.
...
bayes_fosr = function(
  ...
  if (ranef == 0 & est.method == "GLS") {
    ...
    stop(
      "The combination of estimation method and covariance structure you specified is not yet implemented."
    )
  }
