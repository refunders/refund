...
I raise these points constructively, and I have written to the authors directly in parallel — offering our reproduction materials so that, if they agree, they can correct the record themselves. I bring the matter to you as well because it bears on the published literature. Having reproduced the authors' own analysis, I believe the article requires a substantial correction; the reasons are documented and fully reproducible:
