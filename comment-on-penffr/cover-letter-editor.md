...
I raise these points constructively, and I first raised them with the authors directly and in private, on [date], setting out the concerns in detail and offering our complete reproduction materials so that, if they agreed, they could correct the record themselves. In reply, the corresponding author, Prof. Jacques, wrote only that the article had "gone through the standard review process and is now published" and that I was "free to contact the ADAC editorial board", without addressing any of the specific points I had raised. I therefore bring the matter to you — as the authors themselves have suggested — because it bears on the published literature. Having reproduced the authors' own analysis, I believe the article requires a substantial correction; the reasons are documented and fully reproducible:
